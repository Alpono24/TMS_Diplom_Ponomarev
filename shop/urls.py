...
from .views import products_view, product_detail, cart_view, add_to_cart, remove_from_cart, delete_selected_products, \
    ...
    pre_order, pre_order_confirmation, error_confirm_order, handler404, handler500, order_history_details, \
    orders_history
...
urlpatterns = [
    ...
    path('orders/<int:order_id>/', order_history_details, name='order_history_details'),
